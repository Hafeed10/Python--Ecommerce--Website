...
// Ensure kofiWidgetOverlay is available globally
if (typeof window !== 'undefined') {
    window.kofiWidgetOverlay = window.kofiWidgetOverlay || {};
}
            ...
            <div className="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
                ...
                <div className="md:w-1/2 px-8 md:px-16">
                    ...
                    <form action="" className="flex flex-col gap-4">
                        ...
                        <input className="p-2 mt-0 rounded-xl border" type="username" name="username" placeholder="username" />
                        ...
                        <button className="bg-green-600 rounded-xl text-white py-2 hover:scale-105 duration-300">Sing in</button>
                    </form>
